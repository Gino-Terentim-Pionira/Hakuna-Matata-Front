 export const errorCases = {
  ...
  DIFFERENT_PASSWORDS_ERROR: 'Jovem, as duas senhas que você me passou não são iguais. Poderia confirmá-las por favor?',
  MISSING_FIELDS_ERROR: 'Calma aí, viajante. Parece que você não preencheu todos os campos corretamente!',
  SENDING_EMAIL_PROBLEM_ERROR: 'Jovem, parece que ocorreu um problema para te enviar esse tal de "e-mail". Aqui na Savana não temos isso, tem como você criar seu passaporte novamente?',
  ...
  SERVER_ERROR: 'Parece que ocorreu um erro durante a nossa viagem, Jovem! Vamos tentar novamente!',
  NON_EXISTING_EMAIL_ERROR: 'A Savana me informou que você é novo por aqui, Jovem! Para acessar a Savana, você deve criar o seu passaporte.',
...
export const editProfileErrorCases: {[key: string]: string} = {
  ...
  IMAGE_FORMAT_ERROR: 'Eita, essa sua foto é muito grande jovem! Tente nos enviar uma menor \n (imagens devem ser menores que 5mb e do tipo jpeg, jpg ou png)',
