    ...
    const script = [
        {
            ...
            image: cheetah,
            texts: [
                `Prazer ${userName}, eu sou eu sou Cheetah, o treinador mais rápido dessas bandas. Somente os mais velozes conseguem me derrotar. Será que um filhote como você vai conseguir se equiparar a mim? Então filhote, já que é a sua primeira vez tentando encarar esse desafio eu vou te explicar sobre as “Habilidades”.`,
