    ...
    const script = [
        {
            ...
            texts: [
                ...
                'Eu sou responsável pela área da Agilidade e vou te ensinar a não ficar para trás com a “Ignorância”. Ao longo do seu treinamento, você receberá pontos de habilidade em cada uma dessas áreas e poderá checá-los no seu passaporte',
