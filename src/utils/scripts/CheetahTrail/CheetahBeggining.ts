    ...
    const script = [
        {
            ...
            image: cheetah,
            texts: [
                `Prazer ${userName}, eu sou eu sou Cheetah, o treinador mais rápido dessas bandas. Somente os mais velozes conseguem me derrotar. Será que um filhote como você vai conseguir se equiparar a mim? Eu sou responsável pela área da Agilidade e vou te ensinar a não ficar para trás com a “Ignorância”`, 
