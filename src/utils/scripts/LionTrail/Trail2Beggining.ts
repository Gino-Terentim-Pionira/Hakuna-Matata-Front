...
const trail2Beggining = async () => {
    ...
    const script = [
        ...
        },
        {
            name: "Leoa",
            image: lioness,
            texts: ["Vejo que é a sua primeira vez entrando numa trilha, certo? Então irei te explicar sobre os “Status”. Para conseguir derrotar de vez a “Ignorância” é preciso se desenvolver em 6 áreas de conhecimento: Agilidade, Estratégia, Inovação Gestão de Mudanças, Gestão de Projetos e, por último…"]
        },
        {
            name: "Leão",
            image: lion,
            texts: ["A liderança! Nós somos os responsáveis pela área de conhecimento da Liderança e temos como objetivo tornar um Aprendiz como você em um verdadeiro líder! Ao longo do seu treinamento, você receberá pontos de status em cada uma dessas áreas e poderá checar eles no seu perfil. Para provar o seu valor, terá que passar pelo nosso desafio."]
        },
        {
            name: "Leoa",
            image: lioness,
