    ...
    const script = [
        {
            ...
            texts: [
                ...
                "Nosso caminho é feito de união e partilha, onde a generosidade do conhecimento ilumina as sombras da ignorância. Escolha sua trilha, viajante. É uma oportunidade para crescer, para brilhar, para se superar.",
